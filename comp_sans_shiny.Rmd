...
fishing_fleet <- studycatchesird::pie_chart_2(fishingfleet,  init, final)
source_authority <- studycatchesird::pie_chart_2(source_authority, init, final, topn = 6)
cat_geo <- studycatchesird::pie_chart_2(cat_geo, init, final)
species <- studycatchesird::pie_chart_2(species, init, final)
species_group <- studycatchesird::pie_chart_2(species_group, init, final)
# gear <- studycatchesird::pie_chart_2(gear, init, final)
Name_En <- studycatchesird::pie_chart_2(Name_En, init, final)
