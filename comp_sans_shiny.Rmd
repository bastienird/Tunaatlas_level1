...
The stratas loss between the first one and the second one are : `r pull(strates_perdues$Precision)`, representing `r round(pourcentage_strates_perdues)` % of the total number of stratas.
