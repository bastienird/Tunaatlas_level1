...
groupement_1  <-   init %>%dplyr::ungroup() %>% mutate(value=round(value)) %>%  dplyr::group_by(!!!rlang::syms(these_col)
  #!!these_col
...
groupement_2  <-   final %>%dplyr::ungroup() %>% mutate(value=round(value)) %>%  dplyr::group_by(!!!rlang::syms(these_col)
  #!!these_col
