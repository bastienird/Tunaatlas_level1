...
mapping_dataset <- read_csv(paste0("data/", entity$data$source[[2]])) #bof mais pour l'instant comme ça 
  ...
  init <- map_codelistsB(con, opts$fact, mapping_dataset, init, mapping_keep_src_code, summary_mapping = FALSE) #this map condelist function is to retrieve the mapping dataset used
