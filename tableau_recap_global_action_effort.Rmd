...
res <- knitr::knit_child("comp_sans_shiny_child_effort.Rmd", envir = environment(), options = do.call(list, unlist(list(parameters, parameter_init =sub_list_dir_2[1], parameter_final = sub_list_dir_2[length(sub_list_dir_2)] , parameter_mapped = TRUE, step_title = "", last_to_first = TRUE ), recursive=FALSE)), quiet = TRUE)
