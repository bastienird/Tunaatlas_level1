...
res <- knitr::knit_child("comp_sans_shiny_child_effort.Rmd", envir = globalenv(), options = do.call(list, unlist(list(parameters,parameter_fact = parameter_fact ), recursive=FALSE)), quiet = TRUE)
