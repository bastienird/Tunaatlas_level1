...
res2 <- knitr::knit_child("comp_sans_shiny_child_effort.Rmd", envir = environment(), options = do.call(list, unlist(list(parameters, parameter_init = sub_list_dir_2[1], child = TRUE, parameter_con = con,parameter_fact = parameter_fact, titre_1 =entity$identifiers[["id"]]), recursive=FALSE)), quiet = TRUE)
```
...
res <- knitr::knit_child("comp_sans_shiny_child_effort.Rmd", envir = environment(), options = do.call(list, unlist(list(parameters, parameter_fact = parameter_fact, parameter_init =sub_list_dir_2[1], parameter_final = sub_list_dir_2[length(sub_list_dir_2)], child = TRUE , parameter_mapped = TRUE, child_header = "" ), recursive=FALSE)), quiet = TRUE)
...
function_all_comp <- function(counting){
  ...
  res <- knitr::knit_child("comp_sans_shiny_child_effort.Rmd", envir = environment(), options = do.call(list, unlist(list(parameters, parameter_init = sub_list_dir_2[counting], parameter_final = sub_list_dir_2[counting+1],  step_title = paste0(" Treatment : " ,last_path(sub_list_dir_2[counting+1])), parameter_con=con,parameter_fact = parameter_fact, parameter_short = TRUE, child = TRUE, step =counting, child_header = "# "  ), recursive=FALSE)), quiet = TRUE)
}
