...
function_all_comp <- function(counting, parameters = parameters_child, parameter_short = TRUE){
step_mapping <- which(sub_list_dir_2=="Markdown/mapping_codelist")
...
if(sub_list_dir_2[counting] == "Markdown/mapping_codelist"){
  assign(TRUE, sub_list_dir_2[counting], pos = environment())
}
