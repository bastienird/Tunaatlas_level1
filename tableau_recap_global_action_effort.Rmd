...
For each treatment on the data, we provide a report on what has been created, disappeared or has been transformed. This allows to see where major changes occurs for specific data needs. 
