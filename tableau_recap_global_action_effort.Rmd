...
assign("titre_1", entity$identifiers[["id"]], envir = environnement())

  assign("parameter_init", sub_list_dir_2[1], envir = environnement())
  assign("child", TRUE, envir = environnement())
  assign("parameter_con", con, envir = environnement())
...
```{r}
  assign("parameter_init", sub_list_dir_2[counting], envir = environnement())
  assign("parameter_final", sub_list_dir_2[counting+1], envir = environnement())
  assign("parameter_short", TRUE, envir = environnement())
  assign("child", TRUE, envir = environnement())
  assign("step", counting, envir = environnement())
  assign("child_header", "# ", envir= environnement())
  assign("step_title", paste0("Treatment : " ,last_path(parameter_final)), envir= environnement())
