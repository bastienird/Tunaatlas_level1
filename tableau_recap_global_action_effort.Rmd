...
parameter_filtering <- if(!is.null(action$filtering)){action$filtering} else{ list(species = NULL, fishingfleet = NULL)}
params <- list(config = config, entity = entity,action = action , parameter_filtering = parameter_filtering)
```
