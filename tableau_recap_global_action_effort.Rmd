...
res2 <- knitr::knit_child("comp_sans_shiny_child_effort.Rmd", envir = environment(), options = do.call(list, unlist(list(parameters, parameter_init = parameter_init, child = TRUE, parameter_con = parameter_con,parameter_fact = parameter_fact ), recursive=FALSE)), quiet = TRUE)
```
...
function_all_comp <- function(counting){
  ...
  res <- knitr::knit_child("comp_sans_shiny_child_effort.Rmd", envir = environment(), options = do.call(list, unlist(list(parameters, parameter_init = sub_list_dir_2[counting], parameter_final = sub_list_dir_2[counting+1],  step_title = paste0(" Treatment : " ,last_path(parameter_final)), parameter_con=parameter_con,parameter_fact = parameter_fact, parameter_short = TRUE, child = TRUE, step =counting, child_header = "# "  ), recursive=FALSE)), quiet = TRUE)
}
