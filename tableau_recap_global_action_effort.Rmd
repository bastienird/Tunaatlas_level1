...
parameters_child <- list(config = params$config, entity = params$entity,opts = opts ,action = action, parameter_filtering = parameter_filtering, parameter_fact = parameter_fact, parameter_con = con,parameter_host =config$software$input$dbi_config$parameters$host, 
...
qflextable2(reduced, captionn ="Evolution of Tons and Number of fish and lines along the steps")
```

```{r echo=FALSE, results='asis', eval=(parameter_fact == "effort")}

qflextable2(reduced,captionn ="Evolution of Sum in hooks and Sum in fishing days and lines along the steps")
