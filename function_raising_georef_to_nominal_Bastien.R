function_raising_georef_to_nominal_Bastien = function(entity,
         config,
         dataset_to_raise,
  ...
  if ( include_CCSBT==TRUE | include_WCPFC==TRUE ) {
    ...
    #@juldebar what if  include_CCSBT==FALSE and include_WCPFC==TRUE and raising_do_not_raise_wcfpc_data==TRUE ?
