                    ...
                    "ICCAT" = {
                      ...
                      if(options$include_ICCAT){
                        ...
                        if (options$iccat_ps_include_type_of_school){ 
                          ...
                          strata_in_withoutschooltype_and_not_in_withshooltype <- strata_in_withoutschooltype_and_not_in_withshooltype[, colnames_to_keep]
                          iccat_ce_WithSchooltypeInfo <- iccat_ce_WithSchooltypeInfo[, colnames_to_keep]
