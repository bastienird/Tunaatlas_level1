...
date: '2022-05-11'
params:
  final: "~/Documents/Tunaatlas_level1/jobs/20220726122346/entities/global_catch_1deg_level0/Markdown/mapping_codelist"
...
```{r}
rawdata<- readRDS(paste0(params$rawdata,"/rds.rds")) #%>% dplyr::filter(source_authority == params$source_authority)
rdslevel0 <- rawdata
