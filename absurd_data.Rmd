...
date: '2022-05-11'
params:
  final: "~/Documents/Tunaatlas_level1/jobs/20220716210940/entities/global_catch_1deg_1m_ps_bb_firms_Bastien_filtering_wcpfc_at_the_end_level0/Markdown/raising"
  plotting: "plot"
...
```{r}
rawdata<- readRDS("data/rawdata.rds") #%>% dplyr::filter(source_authority == params$source_authority)
rdslevel0 <- rawdata
