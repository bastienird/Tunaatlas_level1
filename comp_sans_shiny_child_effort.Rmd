...
if(is_null_or_not_exist(parameter_filtering)){parameter_filtering <- list(column = NULL, column2= NULL)}else{matchingList <- parameter_filtering %>% purrr::keep( ~ !is.null(.) )}
```
