...
```{r echo=FALSE, fig.cap='Other dimensions', fig.subcap=c(unlist(gsub("_","..",dimension_title_subfigures))), eval=unique_analyse, fig.ncol = 2, out.width = "50%", fig.align = "center"}
