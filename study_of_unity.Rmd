---
title: "study_of_unitiers"
author: "Bastien Grasset"
date: '2022-03-07'
output: html_document
params:
  fichier: "~/Documents/Analyse_des_scripts/Test01_02/lancement/Rds/step3_before_unit_modification.Rds"
---
...
This markdown is aimed to study the repartition of each unity in the initial and final dataset.

```{r}
step3_before_unit_modification <- readRDS(params$fichier) %>% mutate(cat= ifelse(unit%in%c("MT", "MTNO"), "Tons", "Number"))
