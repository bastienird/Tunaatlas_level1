...
params:
  ...
  con: con
  filtering: !r list(species = c("ALB", "BET", "BFT", "SKJ", "YFT"))
---
...
if("try-error" %in% class(out)){conn <- DBI::dbConnect(RPostgres::Postgres() , dbname = params$dbname, host = params$host,   port = params$port,
                                                       user = params$user,
